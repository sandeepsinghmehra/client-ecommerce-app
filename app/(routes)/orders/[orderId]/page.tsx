        ...
        <div className='container px-5 mx-auto'>
          <div className='lg:w-4/5 h-full mx-auto flex flex-wrap'>
            <div className='w-full lg:pr-10 lg:py-6 lg:mb-0'>
              ...
              <p className='leading-relaxed mb-4'> Your Payment Status is: <span className={order.status.toLowerCase() === 'paid'? 'text-green-700 font-bold': 'text-orange-400 font-bold'}>{order.status}</span></p>
              ...
              <div className='flex flex-col items-end'>
                <div className='font-medium text-2xl text-gray-700 mt-7'>SubTotal: ${JSON.parse(order.paymentInfo).TXNAMOUNT}</div>
                <div className='my-6'>
                  <Button
                    variant={'destructive'}
                    size={'sm'}
